package Es.para.encontrar.libros.Principal;

import Es.para.encontrar.libros.Models.*;
import Es.para.encontrar.libros.Repository.AutorRepository;
import Es.para.encontrar.libros.Repository.LibroRepository;
import Es.para.encontrar.libros.Service.ApiService;
import Es.para.encontrar.libros.Service.ConvertidorDatos;
    ...
    private void buscarLibroPorTitulo() {
        ...
        if (datos != null && !datos.resultados().isEmpty()) {
            ...
            if (libroExiste.isPresent()) {
                System.out.println("\nEl libro ya esta registrado, prueba otro\n");
            } else {
